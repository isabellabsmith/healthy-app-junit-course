...
import healthycoderapp.ActivityCalculator;
...
public class ActivityCalculatorTest {
    ...
    void should_ReturnBad_When_AvgBelow20() {
        ...
        // when
        String actual = ActivityCalculator.rateAcitivityLevel(
    ...
    void should_ThrowException_When_InputBelowZero() {
        ...
        // when
        Executable executable = () -> ActivityCalculator.rateAcitivityLevel(
                weeklyCardioMins, weeklyWorkouts
        );
